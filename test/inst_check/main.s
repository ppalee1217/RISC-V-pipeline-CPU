...
# // ==================
  ...
  sw t5, -4(s0)      # 12345678
  sb t5, -8(s0)      # 00000078
  sh t5, -12(s0)     # 00005678
  sb t5, -13(s0)     # 78000000
  sh t5, -18(s0)     # 00005678
# // ==================
...
mul:
  ...
  li t1, 0x0000
  mul t0, t0, t1     # t0 = 0
  sw t0, 0(s0)       # t0 = 0 (0x00000000)
  li t0, 0xffff      # t0 = -1 (16 bits)
  li t1, 0xffff      # t1 = -1 (16 bits)
  mul t0, t0, t1     # t0 = 1 (0x00000001)
  sw t0, 4(s0)
  li t0, 0x7fff      # t0 = 32767 (16 bits)
  li t1, 0x7fff      # t1 = 32767 (16 bits)
  mul t0, t0, t1     # t0 = 1073676289 (0x3fff0001)
  sw t0, 8(s0)
  li t0, 0x8000      # t0 = -32768 (16 bits)
  li t1, 0x8000      # t1 = -32768 (16 bits)
  mul t0, t0, t1     # t0 = 1073741824 (0x40000000)
  sw t0, 12(s0)
  li t0, 0x5555      # t0 = 21845 (16 bits)
  li t1, 0x9999      # t1 = -26215 (16 bits)
  mul t0, t0, t1     # t0 = -572666675 (0xddddcccd)
  sw t0, 16(s0)
  addi s0, s0, 20
div:
  li t0, 100
  li t1, 3
  div t0, t0, t1     # t0 = 33 (0x00000021)
  sw t0, 0(s0)
  li t0, -100
  li t1, 3
  div t0, t0, t1     # t0 = -33 (0xffffffdf)
  sw t0, 4(s0)
  li t0, -100
  li t1, -3
  div t0, t0, t1     # t0 = 33 (0x00000021)
...
divu:
  li t0, 100
  li t1, 3
  divu t0, t0, t1    # t0 = 33 (0x00000021)
  sw t0, 0(s0)
  li t0, -100        # t0 = 4294967196 (0xfffffff9c)
  li t1, 3
  divu t0, t0, t1    # t0 = 1431655732 (0x55555534)
  sw t0, 4(s0)
  addi s0, s0, 8
rem:
  li t0, 100
  li t1, 3
  rem t0, t0, t1     # t0 = 1 (0x00000001)
  sw t0, 0(s0)
  li t0, -100
  li t1, 3
  rem t0, t0, t1     # t0 = -1 (0xffffffff)
  sw t0, 4(s0)
  li t0, -100
  li t1, -3
  rem t0, t0, t1     # t0 = -1 (0xffffffff)
...
remu:
  li t0, 100
  li t1, 3
  remu t0, t0, t1    # t0 = 1 (0x00000001)
  sw t0, 0(s0)
  li t0, -100        # t0 = 4294967196 (0xfffffff9c)
  li t1, 3
  remu t0, t0, t1    # t0 = 0 (0x00000000)
  sw t0, 4(s0)
  addi s0, s0, 8
